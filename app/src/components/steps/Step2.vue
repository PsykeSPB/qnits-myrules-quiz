<template>
  <div class="questions__wrapper">
    <div class="questions__question-title">
      Чувствуете ли вы усталость, тяжесть или гудение в ногах в конце рабочего дня?
    </div>
      ...
      >
        <label class="b-radio radio" tabindex="2">
          ...
          <span class="control-label">
            <div class="answer">
              <div class="answer__title">
                К счастью нет, в конце дня у меня ещё много сил
              </div>
            </div>
          </span>
        </label>
...
export default {
  ...
  methods: {
    select(id) {
      ...
      this.$store.dispatch('answer', { variant: id, sum: 720 });
    },
  },
};
</script>
