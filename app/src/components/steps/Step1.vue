<template>
  <div class="questions__wrapper">
    <div class="questions__question-title">
      Пахнут ли ваши ноги в конце рабочего дня?
    </div>
          ...
          <span class="control-label">
            <div class="answer">
              <div class="answer__title">
                О да, замечал(а) это не однократно
              </div>
            </div>
          </span>
        </label>
      ...
      >
        <label class="b-radio radio" tabindex="1">
          ...
          <span class="control-label">
            <div class="answer">
              <div class="answer__title">
                Да, но это нормально, запах не сильный
              </div>
            </div>
          </span>
        </label>
...
export default {
  ...
  methods: {
    select(id) {
      ...
      this.$store.dispatch('answer', { variant: id, sum: 480 });
    },
  },
};
</script>
