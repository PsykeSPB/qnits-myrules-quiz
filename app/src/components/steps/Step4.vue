<template>
  <div class="questions__wrapper">
    <div class="questions__question-title">
      Какую длину носка вы предпочитаете?
    </div>
          ...
          <span class="control-label">
            <div class="answer">
              <div class="answer__title">
                Мне нравится деловой - длинный вариант (до голени)
              </div>
            </div>
          </span>
        </label>
      ...
      >
        <label class="b-radio radio" tabindex="1">
          ...
          <span class="control-label">
            <div class="answer">
              <div class="answer__title">
                Предпочитаю универсальный - средний вариант (чуть выше косточки)
              </div>
            </div>
          </span>
        </label>
      ...
      >
        <label class="b-radio radio" tabindex="2">
          ...
          <span class="control-label">
            <div class="answer">
              <div class="answer__title">
                Мой выбор спортивный/молодёжный вариант - короткие (чуть ниже косточки)
              </div>
            </div>
          </span>
        </label>
...
export default {
  ...
  methods: {
    select(id) {
      ...
      this.$store.dispatch('answer', { variant: id, sum: 1200 });
    },
  },
};
</script>
