<template>
  <div class="questions__wrapper">
    <div class="questions__question-title">
      Что для вас является главным в носках?
    </div>
    <div class="questions-variants">
      ...
      >
        <label class="b-radio radio" tabindex="1">
          ...
          <span class="control-label">
            <div class="answer">
              <div class="answer__title">
                Экологичные материалы и качественный крой
              </div>
            </div>
          </span>
        </label>
      ...
      >
        <label class="b-radio radio" tabindex="2">
          ...
          <span class="control-label">
            <div class="answer">
              <div class="answer__title">
                Главное, чтобы ноги не потели и не пахли
              </div>
            </div>
          </span>
        </label>
      ...
      <div class="questions-variants__textVariant"
        v-bind:class="{ 'selected': selection[3] }"
        @click="select(3)"
      >
        <label class="b-radio radio" tabindex="3">
          <input type="radio" value="1">
          <span class="check"></span>
          <span class="control-label">
            <div class="answer">
      ...
      <div class="questions-variants__textVariant"
        v-bind:class="{ 'selected': selection[4] }"
        @click="select(4)"
      >
        <label class="b-radio radio" tabindex="4">
          <input type="radio" value="1">
          <span class="check"></span>
          <span class="control-label">
            <div class="answer">
...
export default {
  ...
  methods: {
    select(id) {
      ...
      this.$store.dispatch('answer', { variant: id, sum: 960 });
    },
  },
};
</script>
